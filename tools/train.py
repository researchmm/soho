...
from SOHO import __version__
from SOHO.apis import set_random_seed, train_model
from SOHO.datasets import build_dataset
from SOHO.models import build_model
from SOHO.utils import collect_env, get_root_logger, traverse_replace
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        ...
        cfg.checkpoint_config.meta = dict(
            VLB_version=__version__, config=cfg.text)
