...
class BaseRunner(metaclass=ABCMeta):
    ...
    def register_lr_hook(self, lr_config):
        if isinstance(lr_config, dict):
            ...
            hook = commons.build_from_cfg(lr_config, HOOKS)
        else:
            hook = lr_config
    ...
    def register_momentum_hook(self, momentum_config):
        ...
        if isinstance(momentum_config, dict):
            ...
            hook = commons.build_from_cfg(momentum_config, HOOKS)
        else:
    ...
    def register_optimizer_hook(self, optimizer_config):
        ...
        if isinstance(optimizer_config, dict):
            ...
            hook = commons.build_from_cfg(optimizer_config, HOOKS)
        else:
    ...
    def register_checkpoint_hook(self, checkpoint_config):
        ...
        if isinstance(checkpoint_config, dict):
            ...
            hook = commons.build_from_cfg(checkpoint_config, HOOKS)
        else:
    ...
    def register_logger_hooks(self, log_config):
        ...
        for info in log_config['hooks']:
            logger_hook = commons.build_from_cfg(
